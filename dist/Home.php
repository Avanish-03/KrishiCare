    ...
    <div class="carousel-container h-3/4 w-full flex overflow-hidden relative">
        <div class="carousel-items h-full w-full flex transition-transform duration-500 ease-linear">
            <div
                ...
                <span class="text-2xl font-normal capitalize px-20">Taking agriculture To The Next Level , Join us in
                    revolutionizing
            ...
            <div
                ...
                <h1 class="text-6xl font-[poppins] h-fit pl-16">"As the earth yields its treasures, <br /> so does the
            ...
            <div
                ...
                <h1 class="text-6xl font-[poppins] h-fit pl-16">"Farming is not merely about growing crops, <br /> it's
            ...
            <div
                ...
                <h1 class="text-6xl font-[poppins] h-fit pl-16">"From the sweat of the farmer's <br /> brow springs the
            ...
            <div
                ...
                <h1 class="text-6xl font-[poppins] h-fit pl-16">"Farming is not just a livelihood, <br /> it's a way of
    ...
    <div class="container px-5 mx-auto bg-white">
        <div class="flex flex-wrap -m-4 text-center">
            <div class="xl:w-1/4 md:w-1/2 ">
                <div class="p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="https://www.nicheagriculture.com/wp-content/uploads/2020/10/ezgif.com-gif-maker-9-1.webp" alt="content">
            ...
            <div class="xl:w-1/4 md:w-1/2 ">
                <div class="p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="https://cdn.uc.assets.prezly.com/712d7152-a1c1-4e19-82f5-2d505c9f4dea/-/resize/1200x/-/format/auto/" alt="content">
            ...
            <div class="xl:w-1/4 md:w-1/2 ">
                <div class="p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="https://www.india.gov.in/sites/upload_files/npi/files/spotlights/soil-health-card-inner.jpg" alt="content">
            ...
            <div class="xl:w-1/4 md:w-1/2 ">
                <div class="p-6 rounded-lg">
                    <img class="h-40 rounded w-full object-cover object-center mb-6"
                        src="https://cdn.britannica.com/87/192187-050-B42C0C0B/Doppler-radars-signal-echo-target-National-Weather.jpg" alt="content">
    ...
    <div class="h-fit w-full py-8 flex justify-center items-center">
        <div class="h-full w-4/5 text-start">
            ...
            <p class="text-lg mt-4 text-gray-700 mb-4 text-justify">Weather plays a pivotal role in the success and
                sustainability of farming, serving as both a blessing and a challenge for agricultural endeavors. Every
                aspect of farming, from crop selection to cultivation practices, is profoundly influenced by weather
                patterns such as temperature, precipitation, humidity, wind, and sunlight. Timely rainfall and moderate
                ...
                patterns due to global warming have brought unpredictability and volatility to weather systems, further
                complicating farming operations. Farmers rely on accurate weather forecasts and data-driven insights to
                make informed decisions about planting, irrigation, pest control, and harvesting, mitigating risks and
                maximizing yields. Moreover, advancements in technology, such as satellite imaging and weather
                monitoring systems, have enabled farmers to monitor weather conditions in real-time, empowering them to
                adapt and innovate in response to changing environmental conditions. In essence, the importance of
                weather in farming cannot be overstated; it is the ultimate arbiter of success or adversity, shaping the
                agricultural landscape and the lives of farmers around the world.
            </p>
        </div>
    </div>
    <div class="container h-96 bg-grey-lightest mx-auto shadow-xl rounded pb-4 bg-cover"
