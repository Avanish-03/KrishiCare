                ...
                <div class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
                    ...
                    <form id="contactForm" method="post" action="#">
                        ...
                        <div class="relative mb-4">
                            ...
                            <span id="spanmsg" class="text-red-500"></span>
                        </div>
                        <button class="text-white bg-green-600 hover:bg-green-700 border-0 py-2 px-6 w-full focus:outline-none rounded text-lg" onclick="return validateContactForm()">Submit Message</button>
                        <p class="text-sm mt-3">If you don't have an account ? <a href="farmer_reg.php" class="text-green-500 underline italic">Register</a></p>
                    </form>
                </div>
