                    ...
                    <div class="relative min-w-96 px-4 py-10 w-[50%] shadow-lg sm:rounded-3xl sm:p-20 md:p-4 grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="w-full h-full mx-auto pl-4 py-8">
                                ...
                                <div class="divide-y divide-gray-200">
                                    <div class="pt-8 pb-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        ...
                                        <div class="relative py-3">
                                            <input type="button" onclick="return ResetPassword('farmer')" class="outline-none cursor-pointer bg-green-600 hover:bg-green-700 text-lg text-white font-serif py-2 px-16 rounded-md  w-full sm:w-full md:w-fit" value="Submit">
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="w-full h- flex justify-around text-sm items-center">
                                ...
                                <p><a class="text-green-400 hover:text-green-600 hover:border-b-2 pb-0.5 hover:border-green-600 duration-100" href="FarmerLogin.php">Login</a></p>
                            </div>
