                            ...
                            <div class="divide-y divide-gray-200">
                                <div class="pt-8 pb-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                    ...
                                    <div class="relative py-3">
                                        <input type="button" onclick="return ResetPassword('farmer')" class="outline-none bg-gradient-to-r cursor-pointer from-green-300 to-green-500 text-white rounded-md px-2 py-1 w-full sm:w-full md:w-fit" value="Submit">
                                    </div>
                                </div>
                            </div>
                        </form>
