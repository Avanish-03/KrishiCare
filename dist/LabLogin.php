...
<body>
    ...
    <section class="h-screen w-screen">
        <div class="h-fit md:h-[60%] w-full flex items-center justify-center my-9">
            <div class="full w-full py-6 flex flex-col justify-center sm:py-12 mt-8">
                <div>
                ...
                <div class="relative px-4 w-full h-full sm:mx-auto flex justify-center">
                    <div class="relative min-w-96 px-4 py-10 w-[50%] shadow-lg sm:rounded-3xl sm:p-20 md:p-4 grid grid-cols-1 md:grid-cols-2">
                        <div class="w-full h-full mx-auto flex justify-center items-center">
                            <img class="h-full md:h-80 w-full" src="../img/chemistry lab-bro.svg" alt="">
                        </div>
                                ...
                                <div class="divide-y divide-gray-200">
                                    <div class="pt-8 pb-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        ...
                                        <div class="relative py-3">
                                            <input type="button" onclick="return validateUser('laboratory')" class="outline-none cursor-pointer bg-green-600 hover:bg-green-700 text-lg text-white font-serif py-2 px-16 rounded-md  w-full sm:w-full md:w-fit" value="Login">
                                        </div>
                                    </div>
                                </div>
                            </form>
                            <div class="w-full h- flex justify-around text-sm items-center">
                                <p>Don't have an account <a class="text-green-400 hover:text-green-600 hover:border-b-2 pb-0.5 hover:border-green-600 duration-100" href="lab_reg.php">Register</a></p>
                                <p><a class="text-green-400 hover:text-green-600 hover:border-b-2 pb-0.5 hover:border-green-600 duration-100" href="LabPassword.php">Change Password</a></p>
                            </div>
