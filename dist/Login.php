                        ...
                        <div class="w-full h-full mx-auto pl-4">
                            <form id="ValidateUser" method="post" action="#">
                                <div class="divide-y divide-gray-200">
                                    <div class="pb-4 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                        <div class="relative">
                                        ...
                                        <div class="relative">
                                            <input type="button" onclick="return varifyAdmin()" class="outline-none cursor-pointer bg-green-600 hover:bg-green-700 text-lg text-white font-serif py-2 px-8 rounded-md  w-full sm:w-full md:w-fit" value="Verify Admin">
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <form id="varifyAdminForm">
                                <div class="relative my-2">
                                    ...
                                    <span class="text-red-500 text-sm" id="spanotp"></span>
                                </div>
                                <div class="relative">
                                    <input type="button" onclick="return validateUser('admin')" class="outline-none cursor-pointer bg-green-600 hover:bg-green-700 text-lg text-white font-serif py-2 px-16 rounded-md  w-full sm:w-full md:w-fit" value="Login">
                                </div>
                            </form>
