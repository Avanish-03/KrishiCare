    ...
    <div class="h-10 w-full bg-slate-200 flex justify-around items-center">
        ...
        <div>
            <span class="flex  items-center">
                <a href="https://www.facebook.com/" class="cursor-pointer text-gray-600">
                ...
                <a href="https://twitter.com/?lang=en-in" class="ml-3 cursor-pointer text-gray-600">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 cursor-pointer" viewBox="0 0 24 24">
                        <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"></path>
                    </svg>
                </a>
                <a href="https://www.instagram.com/" class="ml-3 cursor-pointer text-gray-600">
                ...
                <a href="https://www.linkedin.com/login" class="ml-3 cursor-pointer text-gray-600">
