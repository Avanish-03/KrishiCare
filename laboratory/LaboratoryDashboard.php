                ...
                <div class="w-full h-[90%] flex">
                    ...
                    <div id="sidebar" class="bg-slate-200 dark:bg-slate-900 h-full p-5 w-72 relative duration-500">
                        ...
                        <div class="w-full h-[60%]">
                            ...
                            <div onclick="labMenuLoader('sample','<?php echo $_SESSION['laboratory'] ?>')" class="w-full py-3 space-x-2 font-bold text-black dark:text-white hover:rounded flex items-center px-3 hover:bg-slate-300 dark:hover:bg-slate-700">
