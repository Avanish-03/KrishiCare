            ...
            <div class="p-4 bg-gray-100 dark:bg-gray-900 rounded-md">
                ...
                <div class="relative mb-2">
                    ...
                    <input type="text" id="table-search"
                        class="block pt-2 ps-10 py-2 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <form id="verifyForm" class="">
                    <div class="relative z-0 w-full my-5 group">
                        <label for="farmername" class=" text-gray-500 dark:text-gray-400 " inputmode="text">Farmer Name
                            : </label>
                        <select name="farmername" id="farmername"
                    ...
                    <div class="relative z-0 w-full my-5 group">
                        <label for="email" class=" text-gray-500 dark:text-gray-400 " inputmode="text">Farmer Email :
                        </label>
                    ...
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" onfocus="this.type='date';" onblur="this.type='text'"
                            min="<?php echo date('Y-m-d'); ?>" name="collectiondate" id="collectiondate"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
                        <label for="collectiondate"
                            class="peer-focus:font-medium absolute text-md text-gray-500 dark:text-gray-400 duration-500 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Soil
                            Collection Date</label>
                    </div>
                    <button type="button" onclick="return verifyUser('<?php echo $_SESSION['laboratory'] ?>')"
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Verify
                        User</button>
                </form>
                ...
                <form id="submitForm" class="">
                    ...
                    <div class="relative z-0 w-full my-5 group">
                        <input type="password" name="verifyotp" id="verifyotp"
                            ...
                            placeholder=" " required />
                        <label for="verifyotp"
                            class="peer-focus:font-medium absolute text-md text-gray-500 dark:text-gray-400 duration-500 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                            inputmode="numeric">Verify OTP</label>
                    </div>

                    <button type="button" onclick="return submitSampleForm('<?php echo $_SESSION['laboratory'] ?>')"
