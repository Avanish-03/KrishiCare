...
<section class="h-full mx-auto my-8 p-8 pb-28 rounded-md">
    ...
    <div class="relative h-32 w-full my-5 flex items-center bg-gray-200 dark:bg-slate-700 bg-cover rounded-md ">
        ...
        <h1 class="font-serif z-10 text-7xl font-bold px-8 transition-all duration-300 bg-cover bg-no-repeat bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-violet-500">Requests By Farmers</h1>
    </div>
