<section class="w-full h-full mx-auto p-8 rounded-md">
                                        ...
                                        <div class="relative transform overflow-hidden rounded-lg bg-white dark:bg-slate-700 text-left shadow-xl transition-all sm:w-full sm:max-w-lg" @click.away="open = false">
                                            <div class="sm:p-10">
                                                ...
                                                <form id="labForm" method="post" action="../Backend/CRUD.php">
                                                    <div class="grid gap-4 gap-y-2 text-lg grid-cols-1 md:grid-cols-4 text-black dark:text-gray-300 font-bold">
                                                        <div class="md:col-span-4">
                                                            <label for="fullname">Lab Name</label>
                                                            <input type="text" name="fullname" id="fullname" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 dark:bg-slate-600" value="" />
                                                        ...
                                                        <div class="md:col-span-4">
                                                            ...
                                                            <span id="spanownership" class="text-red-500 text-sm"></span>
                                                        </div>
                                                    ...
                                                    <div class="mt-6 flex justify-center gap-x-4">
                                                        <input type="button" value="Register" name="addfarmer" class="py-2 w-full inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-green-700 text-gray-100 shadow-sm align-middle hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-green-600 transition-all text-lg" onclick="return addLaboratory()">
                                                ...
                                                <input type="" name="" id="status" class="bg-black text-white">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="h-32 w-full bg-gray-200 rounded-lg my-8 dark:bg-slate-600 flex items-center">
        <div class="w-[100%] h-full flex items-center">
            <h1 class="h-full flex justify-center items-center text-6xl font-bold px-8 transition-all duration-300 bg-cover bg-no-repeat bg-clip-text text-transparent bg-gradient-to-r from-green-500 to-violet-500">Approve Laboratory</h1>
        </div>
    </div>
    <!-- laboratory -->
    <div class="bg-gray-200 dark:bg-slate-600 w-full h-fit rounded my-8 flex items-center duration-300">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr class='bg-gray-100 dark:text-gray-300 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600'>
                                    ...
                                    <td class='px-6 py-2'>
                                        <button onclick="ApproveLab('<?php echo $row['lab_id'] ?>','<?php echo $row['email'] ?>')" class='px-6 py-2 rounded-lg bg-green-400 hover:bg-green-500 text-gray-50 dark:text-gray-700'>
