                            ...
                            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:w-full sm:max-w-lg" @click.away="open = false">
                                <div class=" sm:p-10">
                                    ...
                                    <div class="mt-6 flex justify-center gap-x-4">
                                        <a class="py-2 w-full inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-green-700 text-gray-100 shadow-sm align-middle hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-700 focus:ring-green-600 transition-all text-lg" href="javascript:;">
                                            Register
                                        </a>
                                    </div>
                                </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            <td class='px-6 py-4'>
                            <a href='./CRUD.php' class='font-medium text-blue-600 dark:text-blue-500 hover:underline'>Edit</a>
