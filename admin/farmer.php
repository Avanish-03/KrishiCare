                            ...
                            <div class=" flex justify-between">
                                ...
                                <div class="flex flex-col items-center justify-center"
                                    ...
                                    <div x-show="open" x-transition:enter="ease-out duration-300"
                                        ...
                                        <div class="relative transform overflow-hidden rounded-lg bg-gray-200 dark:bg-slate-700 text-left shadow-xl transition-all sm:w-full sm:max-w-lg"
                                            ...
                                            <div class="sm:p-10">
                                                ...
                                                <form id="farmForm" method="post" action="../Backend/CRUD.php">
                                                    <div
                                                        class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4 text-black dark:text-gray-300 font-bold">
