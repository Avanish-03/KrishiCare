                ...
                <div class=" ">
                        ...
                        <div class="md:w-2/3 max-w-sm mx-auto">
                            ...
                            <div class="w-full inline-flex">
                                <div class="pt-2 w-1/12 bg-gray-800 bg-opacity-50">
                                    <svg fill="none" class="w-6 text-black dark:text-white duration-700 mx-auto" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="md:inline-flex  space-y-4 md:space-y-0 w-full p-4 border-b border-slate-600 dark:border-slate-300 text-black dark:text-white duration-700 items-center">
                        ...
                        <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                            <div>
                                <label class="text-sm text-black dark:text-white duration-700">Full name</label>
                                <div class="w-full inline-flex ">
                            ...
                            <div>
                                <label class="text-sm text-black dark:text-white duration-700">Phone number</label>
                                <div class="w-full inline-flex ">
                                    <div class="pt-2 w-1/12 bg-gray-800 bg-opacity-50">
                                        <svg fill="none" class="w-6 text-black dark:text-white duration-700 mx-auto  " viewBox="0 0 24 24" stroke="currentColor">
