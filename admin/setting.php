...
<section class="w-full h-full mx-auto p-8 rounded-md">
    ...
    <div class="h-fit w-full bg-gray-200 dark:bg-slate-600 my-8 px-8 py-8 rounded-md">
        <div class="px-12 py-12 bg-gray-300 rounded-md">
    ...
    <div class="h-auto w-full my-8 px-8 rounded-md bg-gray-200 dark:bg-slate-600 duration-700 py-8">
        <!-- Update Form -->
