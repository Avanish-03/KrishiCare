    ...
    <div class="my-8 h-full w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="w-fit h-fit rounded-lg">
            <div class="max-w-2xl mx-auto">
                <div class="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm dark:bg-slate-600 dark:border-slate-700">
                    <a href="#">
                        <!-- <img class="rounded-t-lg"
                            src="https://img.freepik.com/free-photo/hand-holding-writing-checklist-application-form-document-clipboard-white-background-3d-illustration_56104-1551.jpg?t=st=1710697177~exp=1710700777~hmac=ab66405f0c3a36efa7c5d316f16ae6197a44e3e8eac8e1bca62f744189b15d18&w=740"
                            alt=""> -->
                    </a>
                    <div class="p-5">
                        <a href="#">
