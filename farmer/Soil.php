    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl">
            ...
            <p class="text-gray-700 dark:text-gray-300">
                ...
                Because these soils drain slowly and take longer to warm up in summer, combined with drying out and cracking in summer, they can often test gardeners.</p>
        </div>
        ...
        <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl">
            ...
            <p class="text-gray-700 dark:text-gray-300">
                ...
                This type of soil is very rarely found in a garden and often imported into a garden to provide an optimum soil base for planting.</p>
        </div>
        ...
        <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl">
            ...
            <p class="text-gray-700 dark:text-gray-300">
                ...
                The fine-grained red and yellow soil is usually fertile while the coarse-grained soil is less fertile.</p>
        </div>
