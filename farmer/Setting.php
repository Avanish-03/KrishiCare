...
<section class="w-full h-full mx-auto my-8 p-8 rounded-md min-w-96">
    ...
    <div class="h-fit w-full my-8 grid grid-cols-1 py-3 lg:grid-cols-2 rounded-md bg-gray-200 dark:bg-slate-700">
        <div class="h-full w-full flex justify-center items-center relative">
            ...
            <div
                class="absolute h-40 w-full top-0 my-8 px-4 rounded-md transition-all duration-300 grid grid-rows-1 sm:grid-rows-3 gap-4">
    ...
    <div
        class="h-fit w-full text-gray-600 dark:text-gray-300 my-8 px-8 rounded-md bg-gray-200 dark:bg-slate-600 duration-700 py-8">
        <!-- Update Form -->
        <h1
            class="text-4xl text-gray-600 dark:text-gray-300 my-2 rounded-md bg-gray-200 dark:bg-slate-600 duration-700 font-serif">
        ...
        <div class="bg-gray-300 dark:bg-slate-700 h-fit rounded-lg px-16 py-4 grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="h-full flex flex-col justify-center items-center">
                ...
                <form id="updateFarmerPassword" class="flex flex-col justify-center items-center ">
                    ...
                    <br>
                    <input
                        class="py-2 px-6  rounded-lg w-fit md:w-[30%] -ml-20 cursor-pointer bg-green-400 hover:bg-green-500 dark:bg-green-500 dark:hover:bg-green-600"
                        onclick="return updateFarmerPassword('<?php echo $_SESSION['farmer'] ?>')" type="button"
                        value="Update">
                </form>
            </div>
