    ...
    <section class="h-full mx-auto my-8 p-8 pb-28 rounded-md">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 mt-5">
            ...
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Pradhan Mantri Kisan Samman Nidhi (PM-KISAN)</h2>
                <p class="text-gray-700 dark:text-gray-400">PM-KISAN is a central sector scheme launched on 24th February 2019 to supplement financial needs of land holding farmers, subject to exclusions. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 2 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Pradhan Mantri Kisan MaanDhan Yojana (PM-KMY)</h2>
                <p class="text-gray-700 dark:text-gray-400">Pradhan Mantri Kisan Maandhan Yojna (PMKMY) is a central sector scheme launched on 12th September 2019 to provide security to the most vulnerable farmer families. <a href="https://maandhan.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 3 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Pradhan Mantri Fasal Bima Yojana (PMFBY)</h2>
                <p class="text-gray-700 dark:text-gray-400">PMFBY was launched in 2016 in order to provide a simple and affordable crop insurance product to ensure comprehensive risk cover for crops to farmers against all non-preventable natural risks from pre-sowing to post-harvest and to provide adequate claim amount. <a href="https://pmfby.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>
            <!-- Soil Type 1 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Modified Interest Subvention Scheme (MISS)</h2>
                <p class="text-gray-700 dark:text-gray-400">The Interest Subvention Scheme (ISS) provides concessional short term agri-loans to the farmers practicing crop husbandry and other allied activities like animal husbandry, dairying and fisheries. <a href="https://pib.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 2 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Agriculture Infrastructure Fund (AIF)</h2>
                <p class="text-gray-700 dark:text-gray-400">Agri Infra Fund was launched under Aatmanirbhar Bharat Package. AIF was introduced with a vision to transform the agriculture infrastructure landscape of the country. <a href="https://vikaspedia.in/schemesall/schemes-for-farmers/agriculture-infrastructure-fund" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 3 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Formation & Promotion of new 10,000 FPOs</h2>
                <p class="text-gray-700 dark:text-gray-400">The Government of India launched the Central Sector Scheme (CSS) for “Formation and Promotion of 10,000 Farmer Producer Organizations (FPOs)” in the year 2020. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>
            <!-- Soil Type 1 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">National beekeeping and Honey Mission (NBHM)</h2>
                <p class="text-gray-700 dark:text-gray-400">National Beekeeping & Honey Mission (NBHM) was launched in 2020 under Atma Nirbhar Bharat Abhiyan for its implementation in the field for overall promotion and development of scientific beekeeping & to achieve the goal of “Sweet Revolution”. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 2 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Market Intervention Scheme and Price support Scheme (MIS-PSS)</h2>
                <p class="text-gray-700 dark:text-gray-400">Ministry of Agriculture & Farmers Welfare implements the Price Support Scheme (PSS) for procurement of pulses, oilseeds and copra. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 3 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Namo Drone Didi</h2>
                <p class="text-gray-700 dark:text-gray-400">The Government has recently approved a Central Sector Scheme for providing drones to the Women Self Help Group (SHGs) for the period from 2024-25 to 2025-26 with an outlay of Rs. 1261 Crores. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>
            <!-- Soil Type 1 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Rastriya Krishi Vikas Yojana-Detailed Project Report based schemes (RKVY- DPR)</h2>
                <p class="text-gray-700 dark:text-gray-400">The scheme focuses on creation of pre & post-harvest infrastructure in agriculture and allied sectors that help in supply of quality inputs, market facilities, etc to farmers. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 2 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Soil Health Card (SHC)</h2>
                <p class="text-gray-700 dark:text-gray-400">Soil health card provides information to farmers on nutrient status of their soil along with recommendation on appropriate dosage of nutrients to be applied for improving soil health and its fertility. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>

            <!-- Soil Type 3 -->
            <div class="bg-gray-200 dark:bg-slate-700 p-6 rounded-md hover:shadow-xl hover:scale-100 transition-all duration-300 ease-in-out">
                <h2 class="text-xl font-semibold mb-2">Rainfed Area Development (RAD)</h2>
                <p class="text-gray-700 dark:text-gray-400">RAD adopts an area based approach in cluster mode for promoting Integrated Farming System (IFS) which focuses on multi-cropping, rotational cropping, inter-cropping, mixed cropping practices with allied activities like horticulture, livestock, fishery, apiculture etc. <a href="https://pmkisan.gov.in/" target="_blank" class="text-blue-300 dark:text-blue-600 hover:text-green-500">read more</a></p>
            </div>
        </div>
        <div class="h-7"></div>
    </section>
