    ...
    <form class="w-full flex justify-center items-center min-w-96">
        ...
        ?>
            <div class="w-[85%] px-8 py-5 rounded-lg bg-gray-300 dark:bg-slate-700 transition-all duration-300">
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="firstname">First name :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="middlename">Middle Name :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="lastname">Last Name :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="emai">Email :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="contact">Contact :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="address">Address :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="city">City :</label>
                ...
                <div class="p-2 flex">
                    <label class="font-bold w-[25%]" for="state">State :</label>
                ...
                <div class="p-2 flex justify-center gap-5 items-center">
                    <input class="p-2 rounded-lg w-[25%] bg-gray-200 dark:bg-slate-600" onclick="return updateFarmerData('<?php echo $_SESSION['farmer']?>')" type="button" value="Update">
    ...
    <form id="updateFarmerPassword" class="w-full flex justify-center items-center min-w-96">
        <div class="w-[85%] px-8 py-5 rounded-lg bg-gray-300 dark:bg-slate-700 transition-all duration-300">
            ...
            <div class="p-2 flex">
                ...
                <input class="p-2 rounded-lg w-[75%] bg-gray-200 dark:bg-slate-600 transition-all duration-300" type="text" name="pwd" id="pwd">
            </div>
            <div class="p-2 flex">
                <label class="font-bold w-[25%]" for="cpwd">Confirm Password :</label>
                <input class="p-2 rounded-lg w-[75%] bg-gray-200 dark:bg-slate-600 transition-all duration-300" type="text" name="cpwd" id="cpwd">
            </div>
            <div class="p-2 flex justify-center gap-5 items-center">
